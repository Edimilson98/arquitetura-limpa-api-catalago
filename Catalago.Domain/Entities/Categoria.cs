using Catalago.Domain.Validation;
using System;
...
namespace Catalago.Domain.Entities
{
    public sealed class Categoria : Entity
    {
        ...
        private void ValidateDomain(string nome, string imagemUrl)
        {
            ...
            DomainExceptionValidation.When(nome.Length < 5,
               "Nome da imagem deve ter no minimo 5 caracteres");
